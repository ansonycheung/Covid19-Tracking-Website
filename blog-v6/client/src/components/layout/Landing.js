...
const Landing = () => (
    <div className="container1 h-100 d-flex flex-column justify-content-center align-items-center">
   <Container
      style={{ height: "75vh" }}
   ...
   >
      ...
      <h5 className="text-white mt-4">Welcome to Discussion Forem! Click Enter to view posts.</h5>
      <Row className="mb-4">
