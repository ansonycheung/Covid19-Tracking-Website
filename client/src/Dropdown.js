				...
				<div>
					{this.state.region === 'Select a region' || this.state.factor === 'Select a factor' ? (
						...
						<div>
							...
							this.state.factor === 'death' && <Demo2 region={this.state.region} title="death" data={this.state.data[this.state.region]} />}
							{this.state.factor === 'positive' && <Demo2 region={this.state.region} title="positive" data={this.state.data[this.state.region]}/>}
							{this.state.factor === 'negative' && <Demo2 region={this.state.region} title="negative" data={this.state.data[this.state.region]}/>}
							{this.state.factor === 'recovered' && (
								<Demo2 region={this.state.region} title="recovered" data={this.state.data[this.state.region]}/>
							)}
							{this.state.factor === 'hospitalized' && (
								<Demo2 region={this.state.region} title="hospitalized" data={this.state.data[this.state.region]}/>
							)}
							{this.state.factor === 'deathIncrease' && (
								<Demo region={this.state.region} title="deathIncrease" data={this.state.data[this.state.region]}/>
							)}
							{this.state.factor === 'positiveIncrease' && (
								<Demo region={this.state.region} title="positiveIncrease" data={this.state.data[this.state.region]}/>
							)}
							{this.state.factor === 'negativeIncrease' && (
								<Demo region={this.state.region} title="negativeIncrease" data={this.state.data[this.state.region]}/>
							)}
							{this.state.factor === 'hospitalizedIncrease' && (
								<Demo region={this.state.region} title="hospitalizedIncrease" data={this.state.data[this.state.region]}/>
							)}
						</div>
					)}
				</div>
