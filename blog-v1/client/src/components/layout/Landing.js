...
const Landing = () => (
   ...
   >
      {" "}
      <Row className="mb-4">
         <h1 className="text-dark display-4 font-weight-bold">COVID-19 Discussion Forem</h1>
      </Row>
      <Row>
         <Col>
      ...
      <h5 className="text-muted mt-4">Welcome to Discussion Forem! Click Entert o view posts.</h5>
      <Row className="mb-4">
