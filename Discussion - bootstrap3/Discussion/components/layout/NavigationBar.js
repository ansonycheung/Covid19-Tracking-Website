...
const Navigationbar = ({ auth, username, onClick }) => (
   ...
   //          />
   //        </ Navbar.Brand>
   //       <Link className="headline navbar-brand pt-3" id="home" to="/" style={{
   //                         color: "rgba(240, 248, 255, 0.8)",
   //                         hover: {
   //                            color: "white"
   //                         }
   ...
   //         <Link to="/logout">
   //         <p variant="outline-light" className="headline mr-sm-2"
   //             style={{
   //                color: "rgba(240, 248, 255, 0.8)",
   //                $nest: {
   //                   '&:hover': {
