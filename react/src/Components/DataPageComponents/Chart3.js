...
import {Axis, Chart, Legend, Point} from 'bizcharts';

const data = require('../../data_resource/states.json');
const title = {
  style: {
    fontSize: 15,
    fill: 'red'
  ...
  return (
      <div>
        <div style={{textAlign: 'center'}}>
          ...
          <p style={{color: 'grey'}}>
            ( Click on the dropdown menu to select a region/factor. Hover on the
            chart to see the detail, )
          </p>
        </div>
